...
export default class userInfo extends Component {
  ...
  footer() {
    return (
      <div>
        <div className="gout-btn">
          <Button type="primary" onClick={this.props.handleLogout}>
            退出
          </Button>
        </div>
      </div>
        ...
        <div className="user">
          ...
          <div className="user-info">
            <ul>
              ...
              <li>
                <span>手机号</span>
                <b>{userinfo.phoneNo}</b>
              </li>
              <li>
                <span>短号</span>
                <b>{userinfo.shortPhoneNo}</b>
              </li>
              <li>
                <span>单位</span>
                <b>{userinfo.deptName}</b>
              </li>
              <li>
                <span>职务</span>
                <b>{userinfo.post}</b>
              ...
              <li className="changePsw_in">
                ...
                <i
                  className="enter"
                  onClick={() => this.setState({ pswFlag: true })}
                >
                  修改
                </i>
              </li>
                    ...
                    <Form layout="horizontal" onSubmit={this.handleSubmit}>
                      ...
                      <div className="changePsw_btngroup">
                        ...
                        <Button
                          type="defalut"
                          htmlType="reset"
                          onClick={() => this.setState({ pswFlag: false })}
                        >
                          取消
                        </Button>
                      </div>
