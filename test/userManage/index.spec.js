...
test("handleChangeStatusAdd", () => {
  ...
  UserManage.find("Button").at(1).simulate("click");
...
test("handleChangeStatusEdit", () => {
  ...
  UserManage.find("tbody tr").at(0).find("a").at(0).simulate("click");
...
test("handleChangeStatus", () => {
  UserManage.find("tbody tr").at(0).find("a").at(1).simulate("click");
  UserManage.find("Popconfirm button").at(1).simulate("click");
  UserManage.find("tbody tr").at(1).find("a").at(1).simulate("click");
  UserManage.find("Popconfirm button").at(1).simulate("click");
});

// 同步人员
test("synchronize", () => {
  UserManage.find(".page-footer Button").at(1).simulate("click");
});
//页码改变
test("pagenext", () => {
...
describe("treeList", () => {
  ...
  it("treeClick", () => {
    treeList.find("li").at(0).find("span").at(0).simulate("click");
  ...
  //树内容点击事件
  it("treeListClick", () => {
    treeList.find("li").at(0).find("span").at(1).simulate("click");
    treeList.find("li").at(1).find("span").at(1).simulate("click");
  });
});
